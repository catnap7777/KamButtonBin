...
let testButton = ButtonItem(id: 1, type: "Button Style", description: "New button styles introduced in iOS15", picture: "buttonstyles")

struct ButtonModel {
  var buttons:[ButtonItem] = [
    ButtonItem(id: 0, type: "Button Styles", description: "New button styles introduced in iOS15", picture: "buttonstyles"),
    ...
    ButtonItem(id: 8, type: "SwiftUI Modifiers", description: "Making life easier for developers everywhere...", picture: "modifiers"),
    ButtonItem(id: 9, type: "Custom Buttons", description: "Design 'em yourself...", picture: "custom"),
